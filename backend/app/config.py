...
class Settings(BaseSettings):
    ...
    match_threshold: float = Field(default=0.60, ge=-1, le=1)
    opencv_detection_max_dimension: int = Field(default=2048, ge=320, le=4096)
    opencv_face_crop_upscale: float = Field(default=2.0, ge=1, le=4)
